                ...
                <div class="box-body">
                    ...
                    <form action="{{route('dashboard.products.update' ,$product->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step=".01" name="purchase_price" class="form-control " value="{{$product->purchase_price}}">
                        </div>
                        <div class="form-group">
                            <label>@lang('site.sale_price')</label>
                            <input type="number" step=".01" name="sale_price" class="form-control " value="{{$product->sale_price}}">
                        </div>
                        <div class="form-group">
